function area = meshSurfaceAreaList(vertices, edges, faces)
%MESHSURFACEAREALIST Surface area of a polyhedral mesh
%
%   S = meshSurfaceAreaList(V, F)
%   S = meshSurfaceAreaList(V, E, F)
...
if isnumeric(faces)
    ...
    for i = 1:size(faces, 1)
        ...
        area(i, 1) = polyArea3d(poly, normals(i,:));
    end
